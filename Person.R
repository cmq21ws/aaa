...
library(tidyverse)
 ...
 Person= R6Class("Person",
                 public = list(
                   ...
                   initialize = function(rdf, mortality_probs, life_expectancy, i, 
                     ...
                     private$life_history = tibble(male = if(rdf$sex[i]==1) ('TRUE') else('FALSE'),
                                          ...
                                          impact=0,
                                          #Standard deviation of SDQ conduct problem subscore at age 5 (sweep 3)
                                          ...
                                          #Standard deviation of SDQ impact score at age 5 (sweep 3)
           ...
           #effects multiply 0, then there is no effects
